...
public class PlayerTwoAttack implements BattleShipState {
	...
	public PlayerTwoAttack(BattleShip battleShip) {
		...
		playerTwoData.setAttacked(false);
		screen.removeListeners();
		screen.attachListeners(controller.playerTwoAttackListener());
